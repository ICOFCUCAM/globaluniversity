-- ===========================================================================
-- ICOF GLOBAL UNIVERSITY — MIGRATIONS 000, 003, 004, 005, 006, 007, 008, 009, 010, 011, 012, 013, 014, 015, 016, IN ORDER
--
-- GENERATED FILE. DO NOT EDIT.
--   Generator: scripts/build-migration-run.mjs
--   Rebuild:   node scripts/build-migration-run.mjs --out=RUN-ALL.sql 000 003 004 005 006 007 008 009 010 011 012 013 014 015 016
--
-- ---------------------------------------------------------------------------
-- HOW TO RUN IT
--
