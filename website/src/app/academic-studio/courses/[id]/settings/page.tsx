...
import { costsOn } from '@/academic/lib/service';
import { PLATFORM_VOICES } from '@/academic/lib/voice/voices';
import { CourseSettings } from '@/academic/components/CourseSettings';
