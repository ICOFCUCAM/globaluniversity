...
export default function ProgrammeTeaser() {
  ...
  return (
    <section
      ...
      // No background and no border: inside the pinned world window, both
      // would hide the map rather than sit on it.
        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-end lg:gap-20">
          <div>
            <h2
              ...
              className="font-heading text-[clamp(1.9rem,4vw,3.1rem)] font-bold leading-[1.1] tracking-[-0.02em] text-white [text-wrap:balance]"
            >
              Find the path that is right for you.
            </h2>
            <p className="mt-7 max-w-lg text-[15.5px] leading-relaxed text-white/70 sm:text-[17px]">
            ...
            return (
              <li key={d.id}>
                <Link
                  ...
                  className="group block border-t border-white/20 py-7 transition-colors duration-300 hover:border-brand-gold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold focus-visible:ring-offset-2"
                >
                  <span className="block font-heading text-[2.6rem] font-bold leading-none tracking-[-0.03em] text-white transition-colors duration-300 group-hover:text-brand-gold">
                    {n}
                  </span>
                  <span className="mt-3 block font-heading text-[16px] font-bold leading-snug text-white">
                    {d.label}
                  </span>
                  <span className="mt-1.5 block font-sans text-[12.5px] text-white/60">
