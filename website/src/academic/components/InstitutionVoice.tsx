  ...
  return (
    <Card className="px-5 py-4 lg:col-span-2">
      <h2 className="flex items-center gap-2 text-sm font-semibold">
        <Mic2 size={16} className="text-studio-brand" /> The university’s own voice
      </h2>
      ...
      {error && <p className="mt-3 rounded border border-red-200 bg-red-50 px-3 py-2 text-sm text-studio-bad">{error}</p>}

      <div className="mt-3 grid gap-2 sm:grid-cols-3">
        <input
          className="rounded-md border border-studio-page-line px-3 py-2 text-sm"
