...
import { CourseChat } from '@/academic/components/CourseChat';
...
export function LectureCompanion({
  ...
  return (
    <section className="rounded-lg border border-studio-page-line bg-studio-page p-5">
      <h2 className="text-sm font-semibold uppercase tracking-wide text-studio-ink-faint">
