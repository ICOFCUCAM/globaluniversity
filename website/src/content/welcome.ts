...
export const chancellor: WelcomeSignatory = {
  ...
  address: [
    ...
    'We are, by conviction, the Community University of Africa. That name is a commitment, not a slogan. It means our classrooms are open to the working adult and the first-generation student. It means our teaching is answerable to the communities our graduates return to serve. And it means that what is learned here is meant to be used — our purpose has always been to bridge the gap between theory and practice, so that knowledge does not stay on the page.',
